...
public class NewLocationMessageHandler implements MessageHandler {
	...
	public void handleMessage(JSONMessage message) {
		...
		if(controller.getCurrentObservedClient() != null && clientId.equals(controller.getCurrentObservedClient().getId())){
			...
			String latString = (String) ((Map) message.get(MessageTypes.NEW_LOCATION)).get(Constants.latitude.toString());
			String lanString = (String) ((Map) message.get(MessageTypes.NEW_LOCATION)).get(Constants.longitude.toString());
